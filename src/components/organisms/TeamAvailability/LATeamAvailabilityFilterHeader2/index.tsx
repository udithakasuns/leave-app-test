...
import { PartialBy, SelectedTeam, Team } from 'src/utils/types';
...
interface Props {
    ...
    allTeams: Team[];
    teams: SelectedTeam[];
    onSelectTeam: (selectedTeam: SelectedTeam) => void;
}

const LATeamAvailabilityFilterHeader2 = ({
        ...
        <>
            <TouchableOpacity
                ...
                {teamChipsList && !isTAforApproveLeave ? (
                    <TeamChipGroup teams={teams} onSelectTeam={onSelectTeam} />
                ) : (
                    <View>
                        <Spacer height={5} />
                        {startDate && endDate ? (
...
export default LATeamAvailabilityFilterHeader2;
